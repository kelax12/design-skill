...
Use Chrome headless, `playwright-cli` (si présent), or a Playwright/Puppeteer script to capture exact-size screenshots.
...
Inspecter visuellement chaque PNG exporté (lecture directe de l'image par l'agent, ou Chrome MCP si connecté) :
